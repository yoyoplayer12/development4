<nav>
    ...
    <ul class="flex bg-[#040404] text-[#F4F4FC] py-4">
        ...
        <?php if(isset($_SESSION["admin"]) && $_SESSION["admin"] == true): ?>
            <li><a href="moderator.php"><h2 class="text-2xl mr-4 hover:text-[#0464A4]">Moderator</h2></a></li>
        <?php endif; ?>
        <?php if(isset($_SESSION["loggedin"])): ?>
            ...
            <li class="text-blue-500 text-2xl"><p><?php $balance = User::getBalance(); echo $balance; ?> Credits</p></li>
        <?php else:?>
